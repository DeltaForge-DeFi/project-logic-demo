...
export declare namespace AaveATokenPayback {
...
export interface AaveATokenPaybackInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AAVE_REFERRAL_CODE"
      | "NO_PARAM_MAPPING"
  ...
  encodeFunctionData(
    ...
    values: [AaveATokenPayback.ParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface AaveATokenPayback extends BaseContract {
  connect(runner?: ContractRunner | null): AaveATokenPayback;
  waitForDeployment(): Promise<this>;

  interface: AaveATokenPaybackInterface;
  ...
  decodeInputs: TypedContractMethod<
    ...
    [AaveATokenPayback.ParamsStructOutput],
    "view"
  >;

  encodeInputs: TypedContractMethod<
    [_params: AaveATokenPayback.ParamsStruct],
    [string],
    "view"
  >;
