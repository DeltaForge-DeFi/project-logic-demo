...
export interface AaveClosePositionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AAVE_REFERRAL_CODE"
      | "NO_PARAM_MAPPING"
  ...
  encodeFunctionData(
    functionFragment: "calculateSafeWithdrawAmount",
...
export interface AaveClosePosition extends BaseContract {
  connect(runner?: ContractRunner | null): AaveClosePosition;
  waitForDeployment(): Promise<this>;

  interface: AaveClosePositionInterface;
  ...
  calculateSafeWithdrawAmount: TypedContractMethod<
    [
  ...
  getFunction(
    nameOrSignature: "calculateSafeWithdrawAmount"
  ): TypedContractMethod<
    [
      totalCollateral: BigNumberish,
      totalDebt: BigNumberish,
