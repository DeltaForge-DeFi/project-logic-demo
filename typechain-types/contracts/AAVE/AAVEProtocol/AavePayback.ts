...
export declare namespace AavePayback {
...
export interface AavePaybackInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AAVE_REFERRAL_CODE"
      | "NO_PARAM_MAPPING"
  ...
  encodeFunctionData(
    ...
    values: [AavePayback.ParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface AavePayback extends BaseContract {
  connect(runner?: ContractRunner | null): AavePayback;
  waitForDeployment(): Promise<this>;

  interface: AavePaybackInterface;
  ...
  decodeInputs: TypedContractMethod<
    ...
    [AavePayback.ParamsStructOutput],
    "view"
  >;

  encodeInputs: TypedContractMethod<
    [_params: AavePayback.ParamsStruct],
    [string],
    "view"
  >;
  ...
  ): TypedContractMethod<[_params: AavePayback.ParamsStruct], [string], "view">;
  getFunction(
