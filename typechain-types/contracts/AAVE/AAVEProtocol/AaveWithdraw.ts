...
export declare namespace AaveWithdraw {
...
export interface AaveWithdrawInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AAVE_REFERRAL_CODE"
      | "NO_PARAM_MAPPING"
  ...
  encodeFunctionData(
    ...
    values: [AaveWithdraw.ParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface AaveWithdraw extends BaseContract {
  connect(runner?: ContractRunner | null): AaveWithdraw;
  waitForDeployment(): Promise<this>;

  interface: AaveWithdrawInterface;
  ...
  decodeInputs: TypedContractMethod<
    ...
    [AaveWithdraw.ParamsStructOutput],
    "view"
  >;

  encodeInputs: TypedContractMethod<
    [_params: AaveWithdraw.ParamsStruct],
    [string],
    "view"
  >;
