...
export interface AaveOpenPositionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AAVE_REFERRAL_CODE"
      | "NO_PARAM_MAPPING"
...
export interface AaveOpenPosition extends BaseContract {
  connect(runner?: ContractRunner | null): AaveOpenPosition;
  waitForDeployment(): Promise<this>;

  interface: AaveOpenPositionInterface;
