...
export declare namespace DataTypes {
  ...
  export type ReserveDataExtendedStruct = {
    configuration: DataTypes.ReserveConfigurationMapStruct;
    liquidityIndex: BigNumberish;
    currentLiquidityRate: BigNumberish;
    variableBorrowIndex: BigNumberish;
  ...
  export type ReserveDataExtendedStructOutput = [
    configuration: DataTypes.ReserveConfigurationMapStructOutput,
    liquidityIndex: bigint,
    currentLiquidityRate: bigint,
    variableBorrowIndex: bigint,
...
export interface IL2Pool extends BaseContract {
  ...
  getReserveDataExtended: TypedContractMethod<
    [asset: AddressLike],
    [DataTypes.ReserveDataExtendedStructOutput],
    "view"
  >;
  ...
  "rebalanceStableBorrowRate(bytes32)": TypedContractMethod<
    [args: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  "swapBorrowRateMode(bytes32)": TypedContractMethod<
    [args: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "rebalanceStableBorrowRate(bytes32)"
  ): TypedContractMethod<[args: BytesLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "swapBorrowRateMode(bytes32)"
  ): TypedContractMethod<[args: BytesLike], [void], "nonpayable">;
  getFunction(
