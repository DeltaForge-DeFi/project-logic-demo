...
export interface MockReaderInterface extends Interface {
  getFunction(
    nameOrSignature: "getAccountPositions" | "marketAddress"
  ): FunctionFragment;
...
export interface MockReader extends BaseContract {
  connect(runner?: ContractRunner | null): MockReader;
  waitForDeployment(): Promise<this>;

  interface: MockReaderInterface;
  ...
  marketAddress: TypedContractMethod<[], [string], "view">;
