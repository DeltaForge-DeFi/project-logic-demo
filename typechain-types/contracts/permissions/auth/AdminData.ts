...
export interface AdminDataInterface extends Interface {
  getFunction(
    nameOrSignature: "admin" | "changeAdmin" | "changeOwner" | "owner"
  ): FunctionFragment;
...
export interface AdminData extends BaseContract {
  connect(runner?: ContractRunner | null): AdminData;
